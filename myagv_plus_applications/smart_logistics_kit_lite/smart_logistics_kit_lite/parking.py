...
class AutomaticParkingVision(Node):
    ...
    def execute_callback(self, goal_handle):
        ...
        self.target_marker_id = goal_handle.request.marker_id
    ...
    def fn_parking(self):
        if self.current_parking_sequence == self.ParkingSequence.search_parking_lot.value:
            ...
            if self._parking_active and self._goal_handle is not None:
