...
#
#   Bringup orbbec astra_pro2 camera:
#     $ ros2 launch orbbec_camera astra_pro2.launch.py
#
#   SLAM:
#   $ ros2 launch rtabmap_demos myagvplus_rgbd_demo.launch.py
#
#   Teleop:
...
def generate_launch_description():
    ...
    nav2_params_file = PathJoinSubstitution(
        [FindPackageShare('rtabmap_demos'), 'params', 'myagvplus_rgbd_nav2_params.yaml']
    )
