# Requirements:
#   Compile myagv_plus_controller and myagv_plus_bringup packages
#
# Example:
#   Bringup myagv_plus:
...
#
#   SLAM:
#   $ ros2 launch rtabmap_demos myagvplus_scan_demo.launch.py
#
#   Teleop:
...
def launch_setup(context, *args, **kwargs):
    ...
    if icp_odometry:
        ...
        nav2_params_file = PathJoinSubstitution(
            [FindPackageShare('rtabmap_demos'), 'params', 'myagvplus_scan_nav2_params.yaml']
        )
    else:
        # original nav2 params
        nav2_params_file = PathJoinSubstitution(
            [FindPackageShare('myagv_plus_navigation2'), 'param', 'myagvplus.yaml']
        )
